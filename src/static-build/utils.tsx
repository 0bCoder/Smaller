...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://i.iters365.com';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://i.iters365.com',
  );
  return 'https://i.iters365.com';
})();
